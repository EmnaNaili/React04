...
const Profile = props =>{
    return (
        ...
        <button onClick={() => props.handleName(props.name)}  style={{backgroundColor:"#5F939A",  border: "none" , borderRadius: "15px",   color: "white",  fontSize: "20px", width:"100px",height:"40px" , margin:"15px"
    }}>
        My Name
      </button>
 ...
 name: "Emna",
 profession: "Student",
 bio: "Software Engineer Student at Medtech",
};
Profile.propTypes ={
